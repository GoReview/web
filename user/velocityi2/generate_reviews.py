...
reviews = {
    'PCB Design': {
        ...
        'Gujarati': [
            'PCB design quality bada maatra ma saras hato ane board manufacturing mate ekdam ready hato.',
...
print('Generated', sum(len(v[lang]) for v in reviews.values() for lang in v), 'localized reviews in reviews.json')
